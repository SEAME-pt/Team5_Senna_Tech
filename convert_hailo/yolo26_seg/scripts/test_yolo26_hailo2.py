...
def yolo26_to_mask(outputs, orig_h, orig_w, score_threshold, top_k):
    ...
    if _output_mode == "per_scale":
        ...
        # det only for the one-time debug print (cheap: only on first call)
...
class SlidingWindowsLaneFitter:
    def __init__(self, n_windows=7, margin=60, min_pixels=50, lane_width_meters=3.7):
