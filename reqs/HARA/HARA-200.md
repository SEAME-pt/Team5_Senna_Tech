...
| :--- | :--- | :--- | :---: | :--- |
| **H1-200** | **Sensor Connection Failure (e.g., disconnected/broken cable)** | System reads 0 km/h and applies maximum motor power to compensate. | **C4** | [DS-HR200-1](../../docs/Decision_support/DS-HR200-1_Comm-Failure-Hazard-Justification.md) |
| **H2-200** | **Incorrect Pulse Reading (e.g., electrical noise/bouncing) leading to Erratic High Value** | System reads excessive speed and performs emergency braking unexpectedly. | **C4** | [DS-HR200-2](../../docs/Decision_support/DS-HR200-2_Data-Corruption-Hazard-Justification.md) |
| **H3-200** | **Incorrect Pulse Reading (e.g., electrical noise/bouncing) leading to Erratic Low Value** | Robot operates above the actual allowed speed limit for the environment. | **C4** | [DS-HR200-2](../../docs/Decision_support/DS-HR200-2_Data-Corruption-Hazard-Justification.md) |
| **H4-200** | **Stale Pulse Data / Latency (e.g., processing delays on STM32)** | Old data causes oscillations in path tracking (instability). | **C2** | [DS-HR200-3](../../docs/Decision_support/DS-HR200-3_Stale-Data-Hazard-Justification.md) |
| **H5-200** | **Pulse Counting Logic Failure (e.g., counter overflow, calculation error)** | Incorrect speed calculation, leading to dangerous system behavior. | **C4** | [DS-HR200-4](../../docs/Decision_support/DS-HR200-4_Incorrect-Config-Hazard-Justification.md) |
| **H6-200** | **Sensor Degradation / Physical Failure** | Sensor provides consistently inaccurate data (offset, drift, stuck value), leading to improper control decisions. | **C4** | [DS-HR200-5](../../docs/Decision_support/DS-HR200-5_Sensor-Degradation-Hazard-Justification.md) |
...
| :--- | :--- | :--- |
| **SG-201** | (Focus H1) The system shall detect the absence of pulses for a prolonged period (indicating disconnected sensor). | [DM-HR200-1](../../docs/Decision_support/DM-HR200-1_Comm-Failure-Mitigation.md) |
| **SG-202** | (Focus H2, H3) The software shall filter spurious pulses to ensure the integrity of the count. | [DM-HR200-2](../../docs/Decision_support/DM-HR200-2_Pulse-Filtering-Mitigation.md) |
| **SG-205** | (Focus: All Hazards) To ensure its integrity and isolation, the pulse sensor driver (interrupt routines and calculation logic) shall operate within a protected memory region configured via MPU (Memory Protection Unit) or a similar hardware mechanism (e.g., TrustZone). | [DM-HR200-3](../../docs/Decision_support/DM-HR200-3_MPU-Isolation-Mitigation.md) |
| **SG-206** | (Focus H5) The RPM/speed calculation logic shall be protected against pulse counter overflow. | [DM-HR200-4](../../docs/Decision_support/DM-HR200-4_Counter-Overflow-Mitigation.md) |
| **SG-207** | (Focus H6) The system shall perform a plausibility check on the speedometer data, comparing it against a secondary source (e.g., IMU-derived velocity or a system dynamics model) to detect sensor drift or physical failure. | [DM-HR200-5](../../docs/Decision_support/DM-HR200-5_Plausibility-Check-Mitigation.md) |
