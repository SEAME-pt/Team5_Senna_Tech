...
class TaxiRobotCTEController:
	...
	This controller now handles only startup parking-out decision generated by
	...
	def update_startup_parking_decision(
		...
		# If a forced window just ended while still in parking-out, go to RETURNING.
		if (
			not forced_active
	...
	def _set_returning_state(self, fsm, reason: str) -> None:
		# Centralized helper: switch to RETURNING and reset controller internals.
