...
model.train(
   ...
   name    = "yolov26n_jose", # (complet_model_name)_(dataset)_v(version)
   ...
   mosaic  = 0.5,          # Combines 4 images into one, artificially increases dataset variety
   ...
   scale       = 0.5,      # Randomly zooms in/out up to 50%, simulates different distances to the lane markings
   copy_paste   = 0.4,     # Copies and pastes objects within the image, simulates occlusions (e.g., other cars blocking the lane)
   mixup        = 0.10,    # Blends two images together, simulates complex scenarios with multiple lanes and vehicles
