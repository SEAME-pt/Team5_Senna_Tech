...
### EXP-100 | Reviewed: ⨯ | Score: 0.5 ### {: #exp-100 data-toc-label="EXP-100" .item-element .item-section class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"}
...
### EXP-101 | Reviewed: ⨯ | Score: 0.165 ### {: #exp-101 data-toc-label="EXP-101" .item-element .item-section class="tsf-score" style="background-color:hsl(19.8, 100%, 59%)"}
...
### EXP-102 | Reviewed: ⨯ | Score: 0.5 ### {: #exp-102 data-toc-label="EXP-102" .item-element .item-section class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"}
...
The system must automatically start and update safelly all useful applications in the vehicle.
{: .expanded-item-element }
