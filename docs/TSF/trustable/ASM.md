...
### ASM-205 | Reviewed: ✔ | Score: 1.0 ### {: #asm-205 data-toc-label="ASM-205" .item-element .item-section class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"}
...
| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EVD-ASM-205](EVD-ASM.md#evd-asm-205) {class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"} | Technical evidence based on the STM32U5 datasheet, confirming the presence and capabilities of the Memory Protection Unit (MPU). | 1.00 | ✔ Item Reviewed<br>✔ Link Reviewed |
...
### ASM-207 | Reviewed: ✔ | Score: 1.0 ### {: #asm-207 data-toc-label="ASM-207" .item-element .item-section class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"}
...
| Item {style="width:25%"} | Summary {style="width:50%"} | Score {style="width:0%"} | Status {style="width:25%"} |
| --- | --- | --- | --- |
| [EVD-ASM-207](EVD-ASM.md#evd-asm-207) {class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"} | Verification of vehicle specifications, confirming that the IMU hardware is available and functional for secondary speed estimation. | 1.00 | ✔ Item Reviewed<br>✔ Link Reviewed |
...
### ASM-300 | Reviewed: ✔ | Score: 1.0 ### {: #asm-300 data-toc-label="ASM-300" .item-element .item-section class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"}
...
### ASM-301 | Reviewed: ✔ | Score: 1.0 ### {: #asm-301 data-toc-label="ASM-301" .item-element .item-section class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"}
...
### ASM-400 | Reviewed: ✔ | Score: 1.0 ### {: #asm-400 data-toc-label="ASM-400" .item-element .item-section class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"}
...
### ASM-504 | Reviewed: ✔ | Score: 1.0 ### {: #asm-504 data-toc-label="ASM-504" .item-element .item-section class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"}
