...
| Item {style="width:15%"} | Summary {style="width:55%"} | Score {style="width:0%"} | Score Origin {style="width:5%"} | Status {style="width:25%"} |
| --- | --- | --- | --- | --- |
| [AST-100](AST.md#ast-100) {class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"} |  | 0.50 | Derived from supporting Statements | ✔ Item Reviewed<br>✔ All Children Linked |
| [AST-101](AST.md#ast-101) {class="tsf-score" style="background-color:hsl(19.8, 100%, 59%)"} |  | 0.17 | Derived from supporting Statements | ✔ Item Reviewed<br>✔ All Children Linked |
| [AST-102](AST.md#ast-102) {class="tsf-score" style="background-color:hsl(60.0, 100%, 47%)"} |  | 0.50 | Derived from supporting Statements | ✔ Item Reviewed<br>✔ All Children Linked |
...
| [AST-603](AST.md#ast-603) {class="tsf-score status-unreviewed" style="background-color:hsl(0.0, 100%, 65%)"} | The new cluster version shall only start on the next time the vehicle turn on again | 0.00 | Missing | ⨯ Item Reviewed<br>✔ All Children Linked |
| [AST-604](AST.md#ast-604) {class="tsf-score status-unreviewed" style="background-color:hsl(0.0, 100%, 65%)"} | The new package shall be validated using checksum or hash before installation | 0.00 | Missing | ⨯ Item Reviewed<br>✔ All Children Linked |

## Compliance for EVD ## {: data-toc-label="EVD"}

| Item {style="width:15%"} | Summary {style="width:55%"} | Score {style="width:0%"} | Score Origin {style="width:5%"} | Status {style="width:25%"} |
| --- | --- | --- | --- | --- |
| [EVD-100](EVD.md#evd-100) {class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"} |  | 1.00 | Validator | ✔ Item Reviewed<br>✔ All Children Linked |
| [EVD-101](EVD.md#evd-101) {class="tsf-score" style="background-color:hsl(39.6, 100%, 53%)"} |  | 0.33 | Validator | ✔ Item Reviewed<br>✔ All Children Linked |
| [EVD-102](EVD.md#evd-102) {class="tsf-score" style="background-color:hsl(120.0, 100%, 30%)"} |  | 1.00 | Validator | ✔ Item Reviewed<br>✔ All Children Linked |
...
| Item {style="width:15%"} | Summary {style="width:55%"} | Score {style="width:0%"} | Score Origin {style="width:5%"} | Status {style="width:25%"} |
| --- | --- | --- | --- | --- |
| [EXP-100](EXP.md#exp-100) {class="tsf-score status-unreviewed" style="background-color:hsl(60.0, 100%, 47%)"} | The CAN bus shall operate at 500 kbps with a bus load of less than 70%. | 0.50 | Missing | ⨯ Item Reviewed<br>✔ All Children Linked |
| [EXP-101](EXP.md#exp-101) {class="tsf-score status-unreviewed" style="background-color:hsl(19.8, 100%, 59%)"} | The dynamic control messages (SPEED, MOTOR_PWR, STEER) shall be transmitted cyclically every 50ms ±10%. | 0.17 | Missing | ⨯ Item Reviewed<br>✔ All Children Linked |
| [EXP-102](EXP.md#exp-102) {class="tsf-score status-unreviewed" style="background-color:hsl(60.0, 100%, 47%)"} | Monitoring messages (BATTERY, TEMPERATURE) should be transmitted every 1000ms ±10%. | 0.50 | Missing | ⨯ Item Reviewed<br>✔ All Children Linked |
...
| [EXP-600](EXP.md#exp-600) {class="tsf-score status-unreviewed" style="background-color:hsl(0.0, 100%, 65%)"} | The system must automatically start and update safelly all useful applications in the vehicle. | 0.00 | Missing | ⨯ Item Reviewed<br>✔ All Children Linked |
...
* _Repository root: /home/bruno/Desktop/SEA_ME/git valido/Team5_Senna_Tech_
* _Commit SHA: f717b5ebf336beaf836029fa775151675d056d89_
* _Commit date/time: 2026-02-25 12:42:05 UTC_
* _Commit tag: clusterqt-v1.0.2-8-gf717b5e_
