...
??? example "click to view figure as table"
    ...
    |bin|count|
    |-|-|
    |0.0-0.1 {style="background-color:hsl(12.0, 100%, 61%)"} |22|
    |0.1-0.2 {style="background-color:hsl(24.0, 100%, 58%)"} |0|
    |0.2-0.3 {style="background-color:hsl(36.0, 100%, 54%)"} |0|
    |0.3-0.4 {style="background-color:hsl(48.0, 100%, 51%)"} |1|
    ...
    |0.9-1.0 {style="background-color:hsl(120.0, 100%, 30%)"} |16|
...
??? example "click to view figure as table"
    ...
    |bin|count|
    |-|-|
    |0.0-0.1 {style="background-color:hsl(12.0, 100%, 61%)"} |17|
    |0.1-0.2 {style="background-color:hsl(24.0, 100%, 58%)"} |1|
    |0.2-0.3 {style="background-color:hsl(36.0, 100%, 54%)"} |0|
    |0.3-0.4 {style="background-color:hsl(48.0, 100%, 51%)"} |0|
    |0.4-0.5 {style="background-color:hsl(60.0, 100%, 47%)"} |0|
    |0.5-0.6 {style="background-color:hsl(72.0, 100%, 44%)"} |2|
    |0.6-0.7 {style="background-color:hsl(84.0, 100%, 40%)"} |0|
    |0.7-0.8 {style="background-color:hsl(96.0, 100%, 37%)"} |0|
    |0.8-0.9 {style="background-color:hsl(108.0, 100%, 33%)"} |0|
...
??? example "click to view figure as table"
    ...
    |0.1-0.2 {style="background-color:hsl(24.0, 100%, 58%)"} |2|
    |0.2-0.3 {style="background-color:hsl(36.0, 100%, 54%)"} |0|
    |0.3-0.4 {style="background-color:hsl(48.0, 100%, 51%)"} |1|
    |0.4-0.5 {style="background-color:hsl(60.0, 100%, 47%)"} |0|
...
|----------|-------|
|statements|87|
|reviewed statements|32|
|unreviewed statements|55|
|orphaned statements|3|
