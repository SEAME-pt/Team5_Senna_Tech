...
??? example "click to view figure as table"
    ...
    |bin|count|
    |-|-|
    |0.0-0.1 {style="background-color:hsl(12.0, 100%, 61%)"} |14|
    ...
    |0.8-0.9 {style="background-color:hsl(108.0, 100%, 33%)"} |1|
    |0.9-1.0 {style="background-color:hsl(120.0, 100%, 30%)"} |24|
...
??? example "click to view figure as table"
    ...
    |bin|count|
    |-|-|
    |0.0-0.1 {style="background-color:hsl(12.0, 100%, 61%)"} |81|
    |0.1-0.2 {style="background-color:hsl(24.0, 100%, 58%)"} |0|
    |0.2-0.3 {style="background-color:hsl(36.0, 100%, 54%)"} |0|
    |0.3-0.4 {style="background-color:hsl(48.0, 100%, 51%)"} |1|
    |0.4-0.5 {style="background-color:hsl(60.0, 100%, 47%)"} |0|
...
|----------|-------|
|statements|111|
|reviewed statements|44|
|unreviewed statements|67|
|orphaned statements|0|
|statements with evidence|43|
|evidence|44|
|expectations|24|
